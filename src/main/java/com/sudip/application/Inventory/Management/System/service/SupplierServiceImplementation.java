...
public class SupplierServiceImplementation implements SupplierService{
   ...
   private SupplierMapper supplierMapper;
    @Autowired
    private EmailServiceTemplateImplementation emailServiceTemplateImplementation;
    @Autowired
    private EmailTemplateService emailTemplateService;

    @Transactional
    @Override
    public ResponseEntity<ApiResponse<?>> saveSupplier(RegisterSupplierRequestDto registerSupplierRequestDto) {
        ...
        ApiResponse<?> apiResponse =new ApiResponse<>( true,"Supplier saved",201, supplier);
    ...
    public ResponseEntity<ApiResponse<?>> listSupplier(PaginationDto paginationDto) {
       ...
       Page<Supplier> supplierPage = null;
        ...
        ApiResponse<?> apiResponse = new ApiResponse<>(true, "user listed successfully", 200, LocalDateTime.now(),listSupplierResponseDto);
